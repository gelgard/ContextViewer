...
|---|---|---|---|
| PG-RT-001, PG-RT-002 | Stage 2-4 + Stage 9-10 | 004-023; **084**, **086**; **089**, **095**, **096**, **097**, **098**, **099**, **100**, **101**, **102**, **103**, **104**, **105**, **106**, **107**, **108**, **109**, **110**, **111**, **112**, **113**, **114**, **115**, **116**, **117**, **118**, **119**, **120**, **121**, **122**, **123**, **124**, **125**, **126**, **127**, **128**, **129**, **130**, **131** | implemented |
| PG-OV-001 | Stage 4-5 + Stage 10 RC UI | 018-029; **127**, **128**, **131** | implemented |
| PG-PL-001 | Stage 4-5 + Stage 8 UI | 018-029 (feeds); **080–083** (preview/UI plan blocks vs JSON) | implemented |
| PG-AR-001, PG-AR-002 | Stage 6 + Stage 10 RC UI | 030-046; **125**, **129**, **131** | implemented |
| PG-HI-001 | Stage 7-8 + Stage 10 RC UI | 047, 049, 051, 052, **083**, **130**, **131** | implemented |
| PG-HI-002 | Stage 7-8 + Stage 10 RC UI | 048-052, **083**, **130** | implemented |
| PG-UX-001 | Stage 6-10 | 036-083 (062-079 design-sync complete incl. **079** plan refinement; **080-083** production UI slices; 067-072 legacy superseded); **084-089**, **095**, **096**, **097**, **098**, **099**, **100**, **101**, **102**, **103**, **104**, **105**, **106**, **107**, **108**, **109**, **110**, **111**, **112**, **113**, **114**, **115**, **116**, **117**, **118**, **119**, **120**, **121**, **122**, **123**, **124**, **125**, **126**, **127**, **128**, **129**, **130**, **131** | implemented |
| PG-EX-001 | Stage 2-10 | 001-083 (062-079 design branch; 080-083 production UI; 067-072 legacy superseded placeholders); **084-089**, **095**, **096**, **097**, **098**, **099**, **100**, **101**, **102**, **103**, **104**, **105**, **106**, **107**, **108**, **109**, **110**, **111**, **112**, **113**, **114**, **115**, **116**, **117**, **118**, **119**, **120**, **121**, **122**, **123**, **124**, **125**, **126**, **127**, **128**, **129**, **130**, **131** | implemented |
...
- `AI Task 130` is completed: Stage 10 **Activity & imports** / history productization (release candidate) applies **`data-cv-history-surface-productization="130"`** + **`history-workspace--product-rc`** + **`hist-product-hero`** on the history workspace HTML while retaining **`data-cv-history-surface="083"`**, **`data-section="history"`**, **`cv-section-history`**, and **083** daily rollup + timeline row bindings from the history workspace bundle only.
- `AI Task 131` is completed: Stage 10 **release-candidate full-page cleanup** aligns global preview chrome and copy across **overview / visualization / history / diff / settings** as one product shell (**`data-cv-release-candidate-full-page-cleanup="131"`**, **`cv-app-shell--rc-page-complete`**) while preserving **`080`**, **127**, **125–130** surface markers, section roots, and embedded **`ui-bootstrap-payload`** truth (page-level presentation only).
...
- Requirement mapping for **126** (complete):
  ...
  - `PG-RT-001`
  - `PG-RT-002`
- Requirement mapping for **127** (complete):
  - `PG-UX-001`
  - `PG-EX-001`
  - `PG-RT-001`
  - `PG-RT-002`
...
- Requirement mapping for **129** (complete):
  ...
  - `PG-RT-001`
  - `PG-RT-002`
- Requirement mapping for **130** (complete):
  - `PG-HI-001`
  - `PG-HI-002`
  - `PG-UX-001`
  - `PG-EX-001`
  - `PG-RT-001`
  - `PG-RT-002`
- Requirement mapping for **131** (complete):
  - `PG-OV-001`
  - `PG-AR-001`
  - `PG-HI-001`
  - `PG-UX-001`
...
- JSON authority separation:
  - `contextJSON/*` is external viewer export metadata only (not local HTML preview or acceptance authority)
...
- Current Stage 10 execution anchor is `AI Task 131`.
