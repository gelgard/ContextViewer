...
## Current Substage
Stage **128** delivered the **overview / Project home** **release-candidate** productization (**`data-cv-overview-surface-productization="128"`**, **`overview-surface--product-rc`**, **`overview-product-hero`**) while preserving **`data-section="overview"`** and **081** dashboard-feed field truth; shared **127** shell and **125/126** surfaces unchanged at the data contract layer
