...
## Current Substage
Stage **129** delivered the **Architecture explorer / visualization** **release-candidate** productization (**`data-cv-visualization-surface-productization="129"`**, **`viz-workspace--product-rc`**, **`viz-product-hero`**) while preserving **`data-section="visualization"`** and **082** unified tree/graph/inspector feed truth; **128** overview, **127** shell, and **125/126** surfaces unchanged at the data contract layer
