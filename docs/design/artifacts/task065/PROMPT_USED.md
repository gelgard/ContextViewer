# PROMPT_USED — Task 065 (local canonical copy)

**Source file in repo:** `docs/design/prompts/figma_information_architecture_prompt.md`

**Scope:** This file preserves the **exact** fenced prompt block intended for the third-party Figma-generation system (AI Task 065). It is part of the **architecture-derived fallback evidence** package (`docs/design/artifacts/task065/README.md`).

**Not primary evidence:** External URLs must not be used as primary evidence for this path; only workspace artifacts.

---

## Exact prompt text (copy-paste block)
